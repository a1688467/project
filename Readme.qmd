...
-   This project uses targets, targets and tarchetypes so ensure you have the requirements installed already. Rstudio is handy as a project file is provided.
...
-   This Readme won't show the executed code parts on Github (i.e. the tables) since I've not bothered to save them (since it often messes up formatting), instead download and build the project then view the rendered files (this also applies to the report).
